import type { GitBranch, GitCommit, GitPullRequest, GitRepository, GitUser } from "./types";
...
export const repositories: GitRepository[] = [
  {
    ...
    owner: "dexhorthy",
    name: "better-github",
    description: "A focused clone of GitHub's repository experience for agent-built software.",
    visibility: "Public",
    defaultBranch: "main",
    stars: 128,
    forks: 14,
...
export const commits: GitCommit[] = [
  ...
  },
  {
    ...
    author: { login: "hubot", name: "Hubot", avatarUrl: "https://avatars.githubusercontent.com/u/7649605?v=4" },
...
export const fileTree = [
  { type: "directory", name: ".github", lastCommit: "Add workflow placeholders", updatedAt: "2026-04-28T18:20:00.000Z" },
  { type: "directory", name: "src", lastCommit: "Build repository overview shell", updatedAt: "2026-04-29T13:06:00.000Z" },
  { type: "file", name: "README.md", lastCommit: "Document local setup", updatedAt: "2026-04-29T12:58:00.000Z" },
